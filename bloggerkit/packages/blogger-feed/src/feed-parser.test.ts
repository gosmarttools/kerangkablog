...
describe('parseFeed', () => {
	const richFeedInput = {
		feed: {
			...
			link: [
				...
				{
					rel: 'self',
					href: 'https://example.com/feeds/posts/default',
					type: 'application/atom+xml',
				},
				{
					rel: 'previous',
					href: 'https://example.com/feeds/posts/default?start-index=1',
					type: 'application/atom+xml',
				},
				{
					rel: 'next',
					href: 'https://example.com/feeds/posts/default?start-index=2',
					type: 'application/atom+xml',
				},
			],
			...
			entry: [
				{
					...
					link: [
						{
							rel: 'alternate',
							href: 'https://example.com/2026/05/first-post.html',
							type: 'text/html',
						},
						{
							rel: 'self',
							href: 'https://example.com/feeds/posts/default/111',
							type: 'application/atom+xml',
						},
						{
							rel: 'replies',
							href: 'https://example.com/2026/05/first-post.html#comments',
							type: 'text/html',
							title: '5 comments',
						},
						{
							rel: 'replies',
							href: 'https://example.com/feeds/posts/default/post-111/comments',
							type: 'application/atom+xml',
						},
					],
					author: [
				...
				},
				{
					...
					content: {
						$t: '<p><img src="https://example.com/content-image.png" /></p>',
					},
					link: [
						{
							rel: 'alternate',
							href: 'https://example.com/2026/05/second-post.html',
							type: 'text/html',
						},
					],
					author: [
				...
				{
					id: {
						$t: 'tag:blogger.com,1999:blog-1234567890123456789.comment-333',
					},
					...
					link: [
						{
							rel: 'alternate',
							href: 'https://example.com/2026/05/first-post.html?m=1#comment-333',
							type: 'text/html',
						},
						{
							rel: 'related',
							href: 'https://example.com/feeds/posts/default/comments/post-111/333',
							type: 'application/atom+xml',
						},
					],
					author: [
						{
							...
							uri: { $t: 'https://example.com/commenter' },
						},
					],
					gd$extendedProperty: [
	...
	it('parses a blogger feed object with posts, comments, pagination, and metadata', () => {
		...
		expect(feed.previousUrl).toBe(
			'https://example.com/feeds/posts/default?start-index=1',
		);
		expect(feed.nextUrl).toBe(
			'https://example.com/feeds/posts/default?start-index=2',
		);
		...
		expect(feed.posts?.[0]).toEqual(
			expect.objectContaining({
				...
				labels: ['test'],
				comments: {
					feed: 'https://example.com/feeds/posts/default/post-111/comments',
					number: 5,
					title: '5 comments',
				},
				geo: {
					box: '1 2 3 4',
					featureName: 'Sample Location',
					point: '10.0 20.0',
				},
			}),
		);
	...
	it('extracts an image thumbnail from summary when no media thumbnail exists', () => {
		const feed = parseFeed({
			entry: {
				...
				summary: {
					$t: '<p><img src="https://example.com/summary-image.png" /></p>',
				},
				link: [
					{
						rel: 'alternate',
						href: 'https://example.com/2026/05/summary-image-post.html',
						type: 'text/html',
					},
				],
				author: [
		...
		const feed = parseFeed({
			entry: {
				...
				link: [
					{
						rel: 'alternate',
						href: 'https://example.com/2026/05/no-count-post.html',
						type: 'text/html',
					},
					{
						rel: 'replies',
						href: 'https://example.com/2026/05/no-count-post.html#comments',
						type: 'text/html',
						title: 'Replies',
					},
				],
		...
		const feed = parseFeed({
			feed: {
				...
				entry: [
					{
						id: {
							$t: 'tag:blogger.com,1999:blog-1234567890123456789.post-555',
						},
						...
						link: [
							{
								rel: 'alternate',
								href: 'https://example.com/2026/05/fallback-avatar-post.html',
								type: 'text/html',
							},
						],
						author: [
